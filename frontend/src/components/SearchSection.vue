...
const handleSearch = async () => {
    ...
    try {
        ...
        const response = await fetch(
            `http://127.0.0.1:3000/api/movies${query}`
        );
    ...
    <section id="search-section" class="py-12 sm:py-16 md:py-20 bg-gray-50">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-8 sm:mb-10 md:mb-12">
                <h2
                    class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-2 sm:mb-3 md:mb-4"
                >
                    Cari Film
                </h2>
            ...
            <div class="max-w-3xl mx-auto">
                <div
                    class="relative bg-white rounded-2xl sm:rounded-3xl md:rounded-full shadow-lg sm:shadow-xl p-1.5 sm:p-2"
                >
                    <div
                        class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-2"
                    >
                        <div
                            class="flex-1 flex items-center px-4 sm:pl-4 md:pl-6"
                        >
                            <svg
                                class="h-5 w-5 sm:h-6 sm:w-6 text-gray-400 mr-3 sm:mr-4 shrink-0"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                            >
                        ...
                        >
                            <span
                                class="relative z-10 flex items-center justify-center gap-2 text-sm sm:text-base"
                            >
                                Cari
                                <svg
            ...
            <div class="mt-8 sm:mt-10 md:mt-12">
                ...
                <!-- No Results -->
                <div
                    v-else-if="hasSearched && movies.length === 0"
                ...
                >
                    ...
                    >
                        <!-- Movie Poster -->
                        <div
                            class="h-64 bg-linear-to-br from-blue-900 to-blue-950 flex items-center justify-center overflow-hidden"
                        >
                            <img
                                ...
                                @error="
                                    (e) => (e.target.src = '/placeholder.jpg')
                                "
                                loading="lazy"
                            />
                            <svg
                                v-else
                                class="h-20 w-20 text-white/50"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                            >
